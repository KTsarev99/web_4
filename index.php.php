...
$workexp = [
    [
        'jobname' => 'Тракторист',
        'from_datastamp' => 'Mar 2017 -',
        'till_datastamp' => 'Current',
    ...
    [
        'jobname' => 'Юрист',
        'from_datastamp' => 'Mar 2015 -',
        'till_datastamp' => ' Dec 2018',
        'description' => 'pellen  consectetur vel in de. Nulla tempors iure',
    ],
    [
        'jobname' => 'Тракторист',
        'from_datastamp' => 'Mar 2010 -',
        'till_datastamp' => ' Dec 2015',
        'description' => 'A soluta ea et odio, unde doloremque repellendu.  consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempors iure,Praesentium magnam iste.',
    ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for($i=0 ;$i<count($workexp); $i++) :?>
            <h5 class="w3-opacity"><b><p><?php echo $workexp [$i]['jobname']; ?></p></b></h5>            
            <h6 class="w3-text-teal"><p><i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $workexp [$i]['from_datastamp']; ?>
            <?php echo $workexp [$i]['till_datastamp']; ?></h6>
